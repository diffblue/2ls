...
Function: array_abstractiont::build_wrap
...
bool array_abstractiont::build_wrap(const exprt &object, exprt &dest, bool write)
{
  // debugging
  return build(object, dest, write);
}

/*******************************************************************\

Function: array_abstractiont::is_ptr_string_struct
...
bool array_abstractiont::is_ptr_string_struct(const typet &type) const
{
...
void array_abstraction(
  symbol_tablet &symbol_table,
  message_handlert &message_handler,
  goto_programt &dest)
{
  array_abstractiont array_abstraction(symbol_table, message_handler);
  array_abstraction(dest);
}
...
Function: array_abstractiont::array_abstractiont
...
Function: array_abstractiont::build_type
...
typet array_abstractiont::build_type(whatt what)
{
  typet type;
...
Function: array_abstractiont::operator()
...
void array_abstractiont::operator()(goto_functionst &dest)
{
...
void array_abstractiont::operator()(goto_programt &dest)
{
  abstract(dest);
...
Function: array_abstractiont::add_str_arguments
...
void array_abstractiont::add_str_arguments(
    const irep_idt & name,
...
Function: array_abstractiont::add_argument
...
void array_abstractiont::add_argument(
    code_typet::parameterst &str_args,
...
Function: array_abstractiont::abstract
...
void array_abstractiont::abstract(goto_programt &dest)
{
  locals.clear();
...
Function: array_abstractiont::declare_define_locals
...
void array_abstractiont::declare_define_locals(goto_programt &dest)
{
...
Function: array_abstractiont::make_decl_and_def
...
void array_abstractiont::make_decl_and_def(goto_programt &dest,
...
Function: array_abstractiont::make_val_or_dummy_rec
...
exprt array_abstractiont::make_val_or_dummy_rec(goto_programt &dest,
    goto_programt::targett ref_instr,
...
Function: array_abstractiont::add_dummy_symbol_and_value
...
symbol_exprt array_abstractiont::add_dummy_symbol_and_value(
    goto_programt &dest,
    goto_programt::targett ref_instr,
...
goto_programt::targett array_abstractiont::abstract(
  goto_programt &dest,
...
Function: array_abstractiont::abstract_assign
...
goto_programt::targett array_abstractiont::abstract_assign(
  goto_programt &dest,
...
Function: array_abstractiont::abstract_function_call
...
void array_abstractiont::abstract_function_call(
  goto_programt &dest,
  goto_programt::targett target)
{
...
Function: array_abstractiont::abstract_return
...
goto_programt::targett array_abstractiont::abstract_return(
  goto_programt &dest,
  goto_programt::targett target)
{
...
Function: array_abstractiont::abstract_ret_val_name
...
Function: array_abstractiont::has_string_macros
...
bool array_abstractiont::has_string_macros(const exprt &expr)
{
...
Function: array_abstractiont::replace_string_macros
...
Function: array_abstractiont::build
...
exprt array_abstractiont::build(
  const exprt &pointer,
  whatt what,
  bool write,
  const source_locationt &location)
...
Function: array_abstractiont::build_abstraction_type
...
const typet& array_abstractiont::build_abstraction_type(const typet &type)
{
...
Function: array_abstractiont::build_abstraction_type_rec
...
const typet& array_abstractiont::build_abstraction_type_rec(const typet &type,
...
bool array_abstractiont::build(const exprt &object, exprt &dest, bool write)
{
...
Function: array_abstractiont::build_if
...
bool array_abstractiont::build_if(const if_exprt &o_if,
...
Function: array_abstractiont::build_array
...
bool array_abstractiont::build_array(const array_exprt &object,
    exprt &dest, bool write)
{
...
Function: array_abstractiont::build_pointer
...
bool array_abstractiont::build_pointer(const exprt &object,
    exprt &dest, bool write)
{
...
Function: array_abstractiont::build_unknown
...
exprt array_abstractiont::build_unknown(whatt what, bool write)
{
...
exprt array_abstractiont::build_unknown(const typet &type, bool write)
{
  if(write)
    return exprt("NULL-object", type);
...
Function: array_abstractiont::build_symbol
...
bool array_abstractiont::build_symbol(const symbol_exprt &sym, exprt &dest)
{
...
Function: array_abstractiont::build_new_symbol
...
void array_abstractiont::build_new_symbol(const symbolt &symbol,
...
Function: array_abstractiont::build_symbol_constant
...
bool array_abstractiont::build_symbol_constant(const mp_integer &zero_length,
    const mp_integer &buf_size, exprt &dest)
{
  ...
  irep_idt identifier="array_abstraction::"+id2string(base);
  ...
  dest=symbol_exprt(identifier, string_struct);
...
Function: array_abstractiont::move_lhs_arithmetic
...
void array_abstractiont::move_lhs_arithmetic(exprt &lhs, exprt &rhs)
{
  if(lhs.id()==ID_minus)
  {
    // move op1 to rhs
...
Function: array_abstractiont::abstract_pointer_assign
...
goto_programt::targett array_abstractiont::abstract_pointer_assign(
  goto_programt &dest,
  goto_programt::targett target)
{
  code_assignt &assign=to_code_assign(target->code);
...
goto_programt::targett array_abstractiont::bounds_check(
  goto_programt &dest,
  goto_programt::targett target,
  const exprt &new_lhs,
  const exprt &index)
...
goto_programt::targett array_abstractiont::read_rec(
  const exprt &src,
  goto_programt &dest,
  goto_programt::targett target)
{
  ...
  else if(src.id()==ID_member)
  {
    ...
    target=read_rec(tmp.struct_op(), dest, target);
  }
  ...
  else if(src.id()==ID_if)
  {
    ...
    target=read_rec(if_expr.true_case(), dest, target);
    target=read_rec(if_expr.false_case(), dest, target);
    target=read_rec(if_expr.cond(), dest, target);
  ...
  else if(src.id()==ID_typecast)
  {
    ...
    {
      target=read_rec(*it, dest, target);
    }
  }
  return target;
}
...
Function: array_abstractiont::abstract_char_assign
...
goto_programt::targett array_abstractiont::abstract_char_assign(
  goto_programt &dest,
  goto_programt::targett target)
{
...
Function: array_abstractiont::char_assign
...
goto_programt::targett array_abstractiont::char_assign(
  goto_programt &dest,
  goto_programt::targett target,
  const exprt &new_lhs,
  const exprt &lhs,
...
Function: array_abstractiont::value_assignments
...
goto_programt::targett array_abstractiont::value_assignments(
    goto_programt &dest,
    goto_programt::targett target,
...
Function: array_abstractiont::value_assignments_if
...
goto_programt::targett array_abstractiont::value_assignments_if(
    goto_programt &dest,
    goto_programt::targett target,
...
Function: array_abstractiont::value_assignments_string_struct
...
goto_programt::targett array_abstractiont::value_assignments_string_struct(
    goto_programt &dest,
    goto_programt::targett target,
    const exprt& lhs, const exprt& rhs)
{
...
Function: array_abstractiont::member
...
exprt array_abstractiont::member(const exprt &a, whatt what)
{
