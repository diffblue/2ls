...
#ifndef CPROVER_SUMMARIZER_BW_TERM_H
#define CPROVER_SUMMARIZER_BW_TERM_H
...
{
 public:
 explicit summarizer_bw_termt(optionst &_options, 
 ...
 protected:
  ...
  void do_summary_term(const function_namet &function_name, 
		  local_SSAt &SSA, 
  ...
  exprt compute_precondition(local_SSAt &SSA,
			  summaryt &summary,
