...
void summarizer_parse_optionst::add_dynamic_object_symbols(const ssa_heap_analysist &heap_analysis,
  ...
  forall_goto_functions(f_it, goto_model.goto_functions)
  {
    forall_goto_program_instructions(i_it, f_it->second.body)
    {
      if (i_it->is_function_call())
      {
        ...
        const irep_idt fname = to_symbol_expr(fun_call.function()).get_identifier();
        auto n_it = i_it; ++n_it;
