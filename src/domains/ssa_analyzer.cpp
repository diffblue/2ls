                               ...
                               template_generator_baset &template_generator)
{
  ...
  if(options.get_bool_option("termination") && compute_ranking_functions)
  {
    ...
    linrank_domaint *linrank_domain = new linrank_domaint(template_generator.renaming_map);
    linrank_domain->add_template(template_generator.var_specs, ns);
...
#else
    lexlinrank_domaint *linrank_domain = new lexlinrank_domaint(template_generator.renaming_map);
    linrank_domain->add_template(template_generator.var_specs, ns);
    domain = linrank_domain;
