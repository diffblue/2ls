...
bool strategy_solver_heap_intervalt::iterate(strategy_solver_baset::invariantt &_inv)
{
...
void strategy_solver_heap_intervalt::set_message_handler(message_handlert &_message_handler)
{
