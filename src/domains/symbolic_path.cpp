...
Function: symbolic_patht::get_expr

  Inputs:

 Outputs:

 Purpose: Get expression correcponding to the path. There is an option
          not to include selected loop guard (this is useful when
          analysing that loop).
